...
export default function DashboardPage() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', marginTop: '24px' }}>
      ...
      {/* Card Clientes */}
      <div onClick={() => router.push('/clientes')} style={{ backgroundColor: 'white', padding: '28px', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.08)', cursor: 'pointer', transition: 'all 0.3s ease', borderLeft: '6px solid #2C5F6F', position: 'relative', overflow: 'hidden', marginTop: '24px' }}>
